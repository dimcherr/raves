...
_SOKOL_PRIVATE void _sapp_win32_create_window(void) {
    ...
    */
    ...
    // Ensure the window is created with styles compatible with OBS
DWORD win_ex_style = WS_EX_APPWINDOW; // Standard app window, no WS_EX_TOPMOST or WS_EX_LAYERED
DWORD win_style = _sapp.fullscreen ? (WS_POPUP | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | WS_VISIBLE) : 
